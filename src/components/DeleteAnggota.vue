<template>
    <div class="container">
        <h1 class="mt-5">Hapus Anggota</h1>
        <div class="mb-3 mt-3">
        ...
        <button class="mb-3 mt-3 mr-3 btn btn-success" v-on:click="deleteAnggota">Hapus</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            deleteAnggota() {
                axios
                .delete("http://127.0.0.1:8000/anggotas/" + this.$route.params.id)
                .then(() => {
